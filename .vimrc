    ...
    nmap <silent> Q tl:bd<Cr>tl:syn on<CR>bn

    "-- hightlight setting --
    " 高亮当前关键字
    noremap <silent> <F1> gd<C-o>
    inoremap <silent> <F1> <ESC> gd<C-o>

    " 取消当前高亮
    noremap <silent> <F1><F1> :nohl<CR>
    inoremap <silent> <F1><F1> <ESC> :nohl<CR>
